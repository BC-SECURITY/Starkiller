  ...
  <div>
    ...
    >
      ...
      <v-row v-if="selectedTemplate">
        ...
        <v-col cols="6">
          <v-subheader> A name for the stager. Leave blank for an autogenerated name. </v-subheader>
        </v-col>
      </v-row>
      <general-form
        v-if="reset"
...
export default {
  ...
  watch: {
    ...
    selectedTemplate: {
      async handler(val) {
        const a = await stagerApi.getStagerTemplate(val)
